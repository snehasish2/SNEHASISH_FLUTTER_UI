...
import 'package:flutter_spotify_ui/widgets/current_track_widget.dart';
...
void main() async {
  ...
  if (!kIsWeb && (Platform.isMacOS || Platform.isLinux || Platform.isWindows)) {
    await DesktopWindow.setMinWindowSize(const Size(600.0, 800.0));
  }
      ...
      body: Column(
        children: [
          Expanded(
            child: Row(
              children: [
                if(MediaQuery.of(context).size.width >100)SideMenu(),
